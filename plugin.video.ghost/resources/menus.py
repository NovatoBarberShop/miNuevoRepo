...
def main_menu():
	...
	#place your Jen playlist here:
    #dulpicate this line with your address
    aa=addDir3('Chains Lists','https://thechains24.com/CHAIN%20REACTION/LISTS.txt',189,'https://thechains24.com/PornKing/ghost.png','https://thechains24.com/PornKing/fanart.jpg','Chains Lists')
    all_d.append(aa)
...
def movie_world():
    ...
    all_d.append(aa)
    'Popular Movies'
    aa=addDir3(Addon.getLocalizedString(32036),f'https://api.themoviedb.org/3/movie/popular?api_key={tmdb_key}&language=%s&page=1'%lang,14,BASE_LOGO+'ghost1.png',all_fanarts['32036'],'Tmdb')
    all_d.append(aa)
    'Released Movies'
